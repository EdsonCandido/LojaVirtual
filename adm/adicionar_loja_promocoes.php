<?php
    $id = $_GET['id'];
    $result = mysql_query("SELECT * FROM produtos_votacao WHERE id= '$id' LIMIT 1");
...
<div class="container">
    <div class="row">
        <div class="page-header">
            <h1><span class="glyphicon glyphicon-list-alt"></span> Adicionar Promoção a Loja</h1>
        </div>
        <form action="processo/cadastro_promocao_loja.php" method="POST" enctype="multipart/form-data">
          ...
          <?php $situacao_id = $resultado['situacao_id'];?>
            ...
            <br>
            <input type="hidden" name="arquivo" value="<?php echo $fotos ?>">
